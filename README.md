NOTE : IF YOU FACED PROBLEMS EARLIER WITH MISSING BACKEND API KEYS, I HAVE FIXED THE ISSUE NOW BY ADDING THE KEYS TO ENVIRONMENT VARIABLES AND REDEPLOYING THEM.
